...
To ensure exact reproducibility, here is the visual walkthrough of the deployment process:
...
*Cloning the deployment repository and initiating the host hardening and setup script.*
...
*Injecting the Harbor VM local IP into the Cloudflare Zero Trust Tunnel configuration without exposing origin IPs.*
<img src="assets/04-cloudflare-route-success.png" alt="Cloudflare Route Configuration" width="800"/>

### 5. Final Harbor Web Interface
*The fully secured, production-ready Harbor Registry interface accessed via the Cloudflare Edge network.*
